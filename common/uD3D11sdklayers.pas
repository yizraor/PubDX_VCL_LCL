UNIT uD3D11sdklayers;

INTERFACE

uses
  Windows, uDXGI, uD3D11;
...
const
  ...
  D3D11_DEBUG_FEATURE_FLUSH_PER_RENDER_OP  = $01;
  D3D11_DEBUG_FEATURE_FINISH_PER_RENDER_OP  = $02;
  D3D11_DEBUG_FEATURE_PRESENT_PER_RENDER_OP  = $04;
  D3D11_DEBUG_FEATURE_ALWAYS_DISCARD_OFFERED_RESOURCE = $08;
...
type
  ...
  LP_D3D11_MESSAGE_CATEGORY = ^D3D11_MESSAGE_CATEGORY;
  ...
  LP_D3D11_MESSAGE_SEVERITY = ^D3D11_MESSAGE_SEVERITY;
  ...
  (
    D3D11_SHADER_TRACKING_OPTION_IGNORE = $0000,
    D3D11_SHADER_TRACKING_OPTION_TRACK_UNINITIALIZED = $0001,
    D3D11_SHADER_TRACKING_OPTION_TRACK_RAW = $0002,
    D3D11_SHADER_TRACKING_OPTION_TRACK_WAR = $0004,
    D3D11_SHADER_TRACKING_OPTION_TRACK_WAW = $0008,
    D3D11_SHADER_TRACKING_OPTION_ALLOW_SAME = $0010,
    D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY = $0020,
    D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS = $0040,
    D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS = $0080,
    D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS = $0100,
    D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS = $0200,
    D3D11_SHADER_TRACKING_OPTION_UAV_SPECIFIC_FLAGS = ( DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS) ),
    D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS = ( DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_RAW) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_WAR) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_WAW) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS) ),
    D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS_ALLOWING_SAME = ( DWORD(D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS) or DWORD(D3D11_SHADER_TRACKING_OPTION_ALLOW_SAME) ),
    D3D11_SHADER_TRACKING_OPTION_ALL_OPTIONS = ( DWORD(D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS_ALLOWING_SAME) or DWORD(D3D11_SHADER_TRACKING_OPTION_TRACK_UNINITIALIZED) )
  );

  LP_D3D11_MESSAGE_ID = ^D3D11_MESSAGE_ID;
  D3D11_MESSAGE_ID =
  (
    ...
    D3D11_MESSAGE_ID_D3D10L9_MESSAGES_START = $00100000,
    ...
    D3D11_MESSAGE_ID_D3D11_MESSAGES_START = $00200000,
    ...
    D3D11_MESSAGE_ID_D3D11_1_MESSAGES_START = $00300000,
  ...
  D3D11_INFO_QUEUE_FILTER_DESC = record
    NumCategories: UINT;
    pCategoryList: LP_D3D11_MESSAGE_CATEGORY;
    NumSeverities: UINT;
    pSeverityList: LP_D3D11_MESSAGE_SEVERITY;
    NumIDs: UINT;
    pIDList: LP_D3D11_MESSAGE_ID;
  end;
  ...
  ID3D11Debug = interface(IUnknown)
    ...
    function GetSwapChain(out pSwapChain: IDXGISwapChain): HRESULT;  stdcall;
  ...
  ID3D11SwitchToRef = interface(IUnknown)
    ...
    function SetUseRef(UseRef: BOOL): BOOL;  stdcall;
    function GetUseRef(): BOOL;  stdcall;
  end;
  ...
  ID3D11InfoQueue = interface(IUnknown)
    ...
    function GetMessage(MessageIndex: UINT64; out Message_: D3D11_MESSAGE; var MessageByteLength: SIZE_T): HRESULT;  stdcall;
    ...
    function AddStorageFilterEntries(const Filter: D3D11_INFO_QUEUE_FILTER): HRESULT;  stdcall;
    function GetStorageFilter(out Filter: D3D11_INFO_QUEUE_FILTER; var FilterByteLength: SIZE_T): HRESULT;  stdcall;
    ...
    function PushStorageFilter(const Filter: D3D11_INFO_QUEUE_FILTER): HRESULT;  stdcall;
    procedure PopStorageFilter();  stdcall;
    function GetStorageFilterStackSize(): UINT;  stdcall;

    function AddRetrievalFilterEntries(const Filter: D3D11_INFO_QUEUE_FILTER): HRESULT;  stdcall;
    function GetRetrievalFilter(out Filter: D3D11_INFO_QUEUE_FILTER; var FilterByteLength): HRESULT;  stdcall;
    ...
    function PushRetrievalFilter(const Filter: D3D11_INFO_QUEUE_FILTER): HRESULT;  stdcall;
    procedure PopRetrievalFilter();  stdcall;
    function GetRetrievalFilterStackSize(): UINT;  stdcall;

    function AddMessage(Cateogry: D3D11_MESSAGE_CATEGORY; Severity: D3D11_MESSAGE_SEVERITY; ID: D3D11_MESSAGE_ID; pDescription: LPCSTR): HRESULT;  stdcall;
    function AddApplicationMessage(Severity: D3D11_MESSAGE_SEVERITY; pDescription: LPCSTR): HRESULT;  stdcall;

    function SetBreakOnCategory(Category: D3D11_MESSAGE_CATEGORY; bEnable: BOOL): HRESULT;  stdcall;
    function SetBreakOnSeverity(Severity: D3D11_MESSAGE_SEVERITY; bEnable: BOOL): HRESULT;  stdcall;
    function SetBreakOnID(ID: D3D11_MESSAGE_ID; bEnable: BOOL): HRESULT;  stdcall;

    function GetBreakOnCategory(Category: D3D11_MESSAGE_CATEGORY): BOOL;  stdcall;
    function GetBreakOnSeverity(Severity: D3D11_MESSAGE_SEVERITY): BOOL;  stdcall;
    function GetBreakOnID(ID: D3D11_MESSAGE_ID): BOOL;  stdcall;

    procedure SetMuteDebugOutput(bMute: BOOL);  stdcall;
